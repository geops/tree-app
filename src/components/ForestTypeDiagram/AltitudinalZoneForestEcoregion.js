...
function AltitudinalZoneForestEcoregion() {
  const { i18n, t } = useTranslation();
  const data = {};
  return (
    <svg x="0px" y="0px" viewBox="0 0 800 400">
      <path
        className={getStyle(data, 'forestEcoregion.4.100')}
        d="M585.39,171.995l41.543,6.552l-41.543,-20.203l0,13.651Z"
      />
      <path
        className={getStyle(data, 'forestEcoregion.3.100')}
