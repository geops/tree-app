...
DROP TABLE IF EXISTS locations_custom_forest_type;
...
COPY
    (WITH l AS
     ...
     LEFT JOIN altitudinal_zones_2085_less_dry_export_mat azm ON ST_Intersects(l.geom, azm.geometry)) TO '/data/locations/export.csv'
DELIMITER ';' CSV HEADER;