...
CREATE TABLE NAT_BODEN (NAISTYP_SORT TEXT, FELD_NAME TEXT, FELD_WERT TEXT);
...
CREATE TABLE NAT_LAGE (NAISTYP_SORT TEXT, FELD_NAME TEXT, FELD_WERT TEXT);
