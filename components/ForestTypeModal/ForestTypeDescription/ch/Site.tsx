...
function Site({
  ...
  return (
    <svg style={{ marginTop: "20px" }} viewBox="0 0 800 400">
      <path
      ...
      />
      <text className={styles.header} x="247" y="226">
      ...
      />
      <text className={styles.header} x="244" y="34">
      ...
      />
      <text className={styles.header} x="16" y="34">
