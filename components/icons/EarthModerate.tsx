...
function EarthModerate({ className, color = "currentColor" }: IconProps) {
  return (
    <svg
      className={className}
    ...
    >
      ...
      />
      <path
        d="M11.8 6l.8.8c1.3-1.4.6-3.1.1-3.8 0 0-.8-1.1 0-2.2l-.8-.8c-1 1.5-.5 3 0 3.6 0 0 .9 1.3-.1 2.4z"
        fill={color}
      />
    </svg>
  );
